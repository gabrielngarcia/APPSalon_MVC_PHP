...
function iniciarApp() {
    ...
    mostrarSeccion(); // Mostrar o ocultas seccion
    tabs(); // Cambia la seccion cuando se presionen los tabs
    botonesPaginador(); //Agrega o quita los botones en el paginador
    paginaSiguiente();
    paginaAnterior();

    consultarAPI(); // Consulta la API en el backend desde php
